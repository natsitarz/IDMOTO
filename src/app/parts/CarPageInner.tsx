...
export default function CarPageInner() {
  ...
  return (
    <div className="relative min-h-[calc(100dvh-67px)] bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 flex flex-col items-center font-[family-name:var(--font-geist-sans)] px-4">
      {/* Hero Section */}
